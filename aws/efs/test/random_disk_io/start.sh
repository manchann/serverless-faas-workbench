...
aws lambda update-function-configuration --function-name efs-test --handler random-write.lambda_handler --memory-size 2048
aws lambda update-function-configuration --function-name tmp-test --handler random-write.lambda_handler --memory-size 2048
...
sleep 5
aws lambda update-function-configuration --function-name efs-test --memory-size 2048
aws lambda update-function-configuration --function-name tmp-test --memory-size 2048
sleep 40
...
sh /Users/manchan/Desktop/programming/serverless-faas-workbench/aws/dynamodb/dynamodb_export_json.sh EFS /Users/manchan/Desktop/BigDataLab/Papers/file_w_test-1
